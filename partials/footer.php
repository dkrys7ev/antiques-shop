				...
				<div class="shell footer__shell">
					...
					>
						...
						<ul class="list-contacts">
							<li>
								<a href="tel:07001234"
									>0700 1234 <span>(FREE CALL)</span></a
								>
							</li>

							<li>
								<a href="mailto:office@antiqueshop.com"
									>office@antiqueshop.com</a
								>
							</li>
						</ul>
						<!-- /.list-contacts -->
									...
									<a href="#">
										<i class="ico-facebook">
											<svg
												...
												width="9.349"
												height="20.256"
												viewBox="0 0 9.349 20.256"
											>
												<path
													d="M9.349 3.549H7.141c-.779 0-.941.319-.941 1.125v1.948h3.149l-.3 3.42H6.203v10.214H2.124V10.085H.003V6.622h2.121V3.895c0-2.558 1.369-3.9 4.4-3.9h2.824z"
													fill="#fff"
												/>
											</svg>
										</i>
									...
									<a href="#">
										<i class="ico-instagram">
											<svg
												...
												width="20.256"
												height="20.256"
												viewBox="0 0 20.256 20.256"
											>
												<defs />
												<path
													fill="#fff"
													d="M16.733 4.844a1.321 1.321 0 11-1.321-1.321 1.321 1.321 0 011.321 1.321"
												/>
												<g
													fill="none"
													stroke="#fff"
													...
													stroke-width="2"
													transform="translate(4.844 4.844)"
												>
													<circle
														stroke="none"
														cx="5.284"
		...
		<script
			type="text/javascript"
			src="assets/dist/scripts/theme.plugins.js"
		></script>
